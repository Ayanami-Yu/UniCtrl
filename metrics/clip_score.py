...
# CLIPsim (video): AnimateDiff = 36.3802, FateZero = 33.8866, TokenFlow = 34.3846, VidToMe = 34.6253, FLATTEN = 34.3304, Vid2Vid-Zero = 34.7291

# CLIPinv (image): SD = 19.784, MasaCtrl = 24.0757, P2P = 23.3297, SEGA = 21.7271, LEDITS++ = 20.9888, MDP = 21.071, CG = 19.54
# CLIPinv (video): AnimateDiff = 22.9229, FateZero = 26.743, TokenFlow = 22.5713, VidToMe = 23.832, FLATTEN = 25.3677, Vid2Vid-Zero = 21.7432
