...
from ctrl_image.ctrl_sd_ddpm_inversion_pipeline import CtrlSDDDPMInversionPipeline
from ctrl_utils.image_utils import image_grid


image_path = "metrics/images/src/default/add/dog_soccer_1.0_0.0.png"
out_dir = "exp/sd/ddpm_inv/dog_soccer"
...
model = CtrlSDDDPMInversionPipeline.from_pretrained(model_path).to(device)
...
for w_src in src_weights:
    for w_tgt in tgt_weights:
        image_rec, image_edit = model(  # TODO check return values
            prompts,
            w_src=w_src,
            w_tgt=w_tgt,
